...
public class Main {
    public static void main(String[] args) {
        ...
        //getNonZeroLenString(pipe, "Please enter your name");
        //getInt(pipe, "Enter an integer");
        //getDouble(pipe, "Enter a decimal");
        //getRangedInt(pipe, "Enter an integer between", 1, 10);
        //getRangedDouble(pipe, "Enter a decimal between", 1.0, 10.0);
        //getYNConfirm(pipe, "Enter Y or N");
        //getRegExString(pipe, "Enter the regEx pattern","\\d{3}-\\d{2}-\\d{4}");
